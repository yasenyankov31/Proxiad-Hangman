...
class GameRestControllerTest {
  ...
  @InjectMocks private GameRestApiController controller;
  ...
  void testGetRankingData() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get(apiPath + "/").contentType(MediaType.APPLICATION_JSON))
  ...
  void testGetEndingResult() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(apiPath + "/endingResult/12345/user1")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(
  ...
  void testGuessLetter() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(apiPath + "/guess/" + game.getId() + "/" + letter)
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.id").value(game.getId()))
        .andExpect(MockMvcResultMatchers.jsonPath("$.guessedWord").value(game.getGuessedWord()))
  ...
  void testResetGame() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(apiPath + "/reset/" + gameId)
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.id").value(game.getId()))
        .andExpect(MockMvcResultMatchers.jsonPath("$.guessedWord").value(game.getGuessedWord()))
  ...
  void testGetGameById() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(apiPath + "/getGame/" + gameId)
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.id").value(game.getId()))
        .andExpect(MockMvcResultMatchers.jsonPath("$.guessedWord").value(game.getGuessedWord()))
