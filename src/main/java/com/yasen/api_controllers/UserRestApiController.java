...
public class UserRestApiController {
	...
	public ResponseEntity<List<UserDto>> updateUser(@Valid @RequestBody UserData userData,
			@PathVariable Integer pageNum, BindingResult result) {
		if (result.hasErrors()) {
	...
	public ResponseEntity<List<UserDto>> deleteUsers(@RequestBody List<Long> ids, @RequestParam Integer pageNum) {
		if (ids.isEmpty()) {
			return ResponseEntity.badRequest().body(null);
		}
