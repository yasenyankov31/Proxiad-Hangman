...
public class UserRestApiController {
  ...
  public ResponseEntity<Page<UserDto>> getUsersData(@RequestParam Integer pageNum) {
    if (pageNum == null) {
      pageNum = 0;
    }
  ...
  @Operation(
      summary = "Get user game statistics and played games",
  ...
  public ResponseEntity<SuccessResponse> createUser(
      @Valid @RequestBody UserData userData, BindingResult result) {
    if (result.hasErrors()) {
