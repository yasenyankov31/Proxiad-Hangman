...
const ParentNavbar = () => {
  ...
  return (
    <>
      {localStorage.getItem("role") !== 'null' && <Navbar bg="dark" variant="dark" expand="lg" className="px-5" fixed="top">
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="mr-auto my-2 my-lg-0 flex-grow-1" style={{ maxHeight: '100px' }} navbarScroll>
            ...
            {localStorage.getItem("role")==="admin" && <Nav.Link as={Link} to="/users/1" className="nav-link"><TranslateI18n id={"NavUsers"} /></Nav.Link>}
          </Nav>
          ...
          <div className="ml-auto d-flex align-items-center">
            ...
            />
            <Button style={{ marginLeft: "15px" }} onClick={() => { logOut() }}><TranslateI18n id={"LogOutBtn"} /></Button>
          </div>
        </Navbar.Collapse>
      </Navbar>}
